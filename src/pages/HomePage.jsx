    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-sky-50">
      ...
      <div className="fixed bottom-16 left-1/2 -translate-x-1/2 z-40">
        <a
          ...
          download
          className="flex items-center gap-2 rounded-full bg-gradient-to-r from-pink-400 to-purple-400 px-5 py-2.5 text-sm font-bold text-white shadow-soft-lg animate-[fadeIn_0.5s_ease-out_0.3s_both] active:scale-95 transition-transform hover:shadow-xl"
        >
